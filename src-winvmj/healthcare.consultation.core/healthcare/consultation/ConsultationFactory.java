...
public class ConsultationFactory{
    ...
    public ConsultationFactory()
    {

    }

    public static Consultation createConsultation(String fullyQualifiedName, Object ... base)
    {
        Consultation record = null;
        try {
            Class<?> clz = Class.forName(fullyQualifiedName);
            Constructor<?> constructor = clz.getDeclaredConstructors()[0];
            record = (Consultation) constructor.newInstance(base);
        } 
